...
export default function Pocetna() {
    ...
    const [pokaziQR, setPokaziQR] = useState(false);
    ...
    return (
        <>
            ...
            <Row>
                <Col xs={12} sm={12} md={9} lg={6} xl={6} xxl={6} className="text-center">
                ...
                <Col xs={12} sm={12} md={3} lg={6} xl={6} xxl={6} className="text-center">
            ...
            <Modal
                show={pokaziQR}
                onHide={() => setPokaziQR(false)}
                centered
                dialogClassName="modal-fade-in"
            >
                <Modal.Header closeButton>
                  <Modal.Title>Doniraj azilu <span style={{color: '#800080'}}>🐾</span></Modal.Title>
              </Modal.Header>
                <Modal.Body className="text-center">
                    <p>Skeniraj QR kod svojom bankovnom aplikacijom:</p>
                    <img
                        src="/qr-donacija.png"
                ...
                <Modal.Footer>
            <Button className="purpleButton" onClick={() => setPokaziQR(false)}>
                Zatvori
            </Button>
        </Modal.Footer>
            </Modal>
