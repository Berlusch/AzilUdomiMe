...
export default function UdomiteljiBrisanje(){
    ...
    async function obrisi (){
        const odgovor= await PasService.obrisi(routeParams.sifra,pas);
        if(odgovor.greska){
    ...
    return(
    <>
    <h2 className="naslov">Brisanje psa</h2>
    ...
    <Form.Group controlId="ime">
        ...
        <Row>
            ...
            <Col xs={6} sm={12} md={9} lg={6} xl={6} xxl={6}>
                ...
                >Obriši psa <svg xmlns="http://www.w3.org/2000/svg" width="24" height="26" fill="#00FF00" class="bi bi-check-lg" viewBox="0 0 16 16" stroke="#00FF00">
