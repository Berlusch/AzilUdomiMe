...
export default function StatusiDodaj(){

    const navigate = useNavigate();     

    async function dodaj(status){
        const odgovor= await StatusService.dodaj(status);
        if(odgovor.greska){
    ...
    return(
    <>
    <h2 className="naslov">Dodavanje statusa</h2>
        ...
        <Row>
            ...
            <Col xs={6} sm={12} md={9} lg={6} xl={6} xxl={6}>
                <Button variant="success" type="submit" className="siroko" style={{ backgroundColor: '#7d3d9b' }}>
                    Dodaj status  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="26" fill="#00FF00" className="bi bi-check-lg" viewBox="0 0 16 16" stroke="#00FF00">
